...
public class ModGlitchteniteGolemAnimations {
    ...
    public static final Animation GLITCHETENITE_GOLEM_WALK = Animation.Builder.create(1.0416767f).looping()
    ...
    public static final Animation GLITCHTENITE_GOLEM_ATTACK = Animation.Builder.create(0.5416766f)
            .addBoneAnimation("left_arm",
                    new Transformation(Transformation.Targets.ROTATE,
                            new Keyframe(0f, AnimationHelper.createRotationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR),
